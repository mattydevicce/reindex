...
class TextsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post texts_url, params: { text: { content: @text.content, description: @text.description, title: @text.title } }
    end
  ...
  test "should update text" do
    patch text_url(@text), params: { text: { content: @text.content, description: @text.description, title: @text.title } }
