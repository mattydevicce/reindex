...
class CalendarDatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar_date" do
    assert_difference('CalendarDate.count') do
      post calendar_dates_url, params: { calendar_date: { date: @calendar_date.date, exception_type: @calendar_date.exception_type, service_id: @calendar_date.service_id } }
    end
  ...
  test "should update calendar_date" do
    patch calendar_date_url(@calendar_date), params: { calendar_date: { date: @calendar_date.date, exception_type: @calendar_date.exception_type, service_id: @calendar_date.service_id } }
