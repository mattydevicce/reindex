...
class ShapesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shape" do
    assert_difference('Shape.count') do
      post shapes_url, params: { shape: { shape_id: @shape.shape_id, shape_pt_lat: @shape.shape_pt_lat, shape_pt_lon: @shape.shape_pt_lon, shape_pt_sequence: @shape.shape_pt_sequence } }
    end
  ...
  test "should update shape" do
    patch shape_url(@shape), params: { shape: { shape_id: @shape.shape_id, shape_pt_lat: @shape.shape_pt_lat, shape_pt_lon: @shape.shape_pt_lon, shape_pt_sequence: @shape.shape_pt_sequence } }
