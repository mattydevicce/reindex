...
class StopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post stops_url, params: { stop: { stop_id: @stop.stop_id, stop_lat: @stop.stop_lat, stop_lon: @stop.stop_lon, stop_name: @stop.stop_name } }
    end
  ...
  test "should update stop" do
    patch stop_url(@stop), params: { stop: { stop_id: @stop.stop_id, stop_lat: @stop.stop_lat, stop_lon: @stop.stop_lon, stop_name: @stop.stop_name } }
